...
# ver 0.85  hibajavítások, duplikálások törlése 2025-10-26
...
VERSION = "0.85 - javítások - 2025-10-26"
...
def deinit_pins():
    ...
    try:
        ...
        # biztos tisztítás; csak logolunk, nem áll le a programfutás
        print("Tisztítás közben hiba történt.")
...
def main_loop():
    ...
    # Nullpont indítása a loop elején (egységes ms méréshez)
    t0 = time.monotonic()
